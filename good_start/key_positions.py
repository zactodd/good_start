...
OVERVIEW_BOARD_BIRD_NAMES = {
    # Forest (top row)
    "forest_1": (0.034, 0.082, 0.110, 0.093),
    "forest_2": (0.137, 0.082, 0.110, 0.093),
    "forest_3": (0.240, 0.082, 0.110, 0.093),
    "forest_4": (0.343, 0.082, 0.110, 0.093),
    "forest_5": (0.446, 0.082, 0.110, 0.093),

    # Grassland (middle row)
    "grassland_1": (0.034, 0.280, 0.110, 0.093),
    "grassland_2": (0.137, 0.280, 0.110, 0.093),
    "grassland_3": (0.240, 0.280, 0.110, 0.093),
    "grassland_4": (0.343, 0.280, 0.110, 0.093),
    "grassland_5": (0.446, 0.280, 0.110, 0.093),

    # Wetland (bottom row)
    "wetland_1": (0.034, 0.478, 0.110, 0.093),
    "wetland_2": (0.137, 0.478, 0.110, 0.093),
    "wetland_3": (0.240, 0.478, 0.110, 0.093),
    "wetland_4": (0.343, 0.478, 0.110, 0.093),
    "wetland_5": (0.446, 0.478, 0.110, 0.093),
}
